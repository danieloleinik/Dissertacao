...
\titulo{{BSN - Usando Computação Evolucional para reduzir a latência em Smart Grid}} % titulo do trabalho em portugues
\title{\MakeUppercase{BSN - Using Evolutionary Computation to reduce the latency in Smart Grid networks}} % titulo do trabalho em ingles
